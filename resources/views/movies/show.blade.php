                            ...
                            <div class="modal w-9/12 bg-gray-900 rounded mx-auto" style="height: 670px;">
                                ...
                                <div class="px-8 py-8">
                                    <div class="responsive-container overflow-hidden relative">
                                        <iframe width="1100" height="515" src="https://www.youtube.com/embed/{{$movie['videos']['results'][0]['key']}}"   style="border:0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            @foreach($movie['cast'] as $cast)
                <div class="mt-8">
                    <a href="{{route('actors.show', $cast['id'])}}">
                        <img src="{{'https://image.tmdb.org/t/p/w300/'.$cast['profile_path']}}" alt="parasite" class=" w-64 md:w-96 hover:opacity-75 transition duration-500 ease-in-out">
                    </a>
                    <div class="mt-2">
